...
public class AssemblyTest {
    ...
    record StringAssemblyOptions(String name, String prefix, int repeat) { }

    @Test
    void test_BasicAssembly() {
        var assembly = Assembly.builder(StringBuilder.class, String.class,
                StringAssemblyOptions.class)
                .setInstanceFactory(options -> new StringBuilder(options.prefix + " "))
        ...
        System.out.println(
                assembly.build(
                        new StringAssemblyOptions("Orbyfied", "cunt", 2)
                )
        );
    }
